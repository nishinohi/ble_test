  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      children: <Widget>[
        ...
        _buildAdvRow(
            context, 'Manufacturer Data', getNiceManufacturerData(result.advertisementData.manufacturerData) ?? 'N/A'),
        _buildAdvRow(
            context,
            'Service UUIDs',
    ...
    if (characteristicTiles.length > 0) {
      return new ExpansionTile(
        title: new Column(
          ...
          children: <Widget>[
            const Text('Service'),
            new Text('0x${service.uuid.toString().toUpperCase().substring(4, 8)}',
      ...
      return new ListTile(
        ...
        subtitle: new Text('0x${service.uuid.toString().toUpperCase().substring(4, 8)}'),
      );
    }
  }
}
  ...
  Widget build(BuildContext context) {
    var actions = new Row(
      ...
      children: <Widget>[
        ...
        new IconButton(
          icon: new Icon(Icons.file_upload, color: Theme.of(context).iconTheme.color.withOpacity(0.5)),
          onPressed: onWritePressed,
        ),
        new IconButton(
          icon: new Icon(characteristic.isNotifying ? Icons.sync_disabled : Icons.sync,
              color: Theme.of(context).iconTheme.color.withOpacity(0.5)),
    ...
    var title = new Column(
      ...
      children: <Widget>[
        ...
        new Text('0x${characteristic.uuid.toString().toUpperCase().substring(4, 8)}',
            style: Theme.of(context).textTheme.body1.copyWith(color: Theme.of(context).textTheme.caption.color))
      ],
    );
    ...
    if (descriptorTiles.length > 0) {
      ...
      return new ListTile(
        title: title,
        subtitle: new Text(new String.fromCharCodes(characteristic.value)),
        trailing: actions,
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    var title = new Column(
      ...
      children: <Widget>[
        ...
        new Text('0x${descriptor.uuid.toString().toUpperCase().substring(4, 8)}',
            style: Theme.of(context).textTheme.body1.copyWith(color: Theme.of(context).textTheme.caption.color))
      ],
    );
    return new ListTile(
